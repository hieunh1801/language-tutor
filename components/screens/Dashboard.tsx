...
export const Dashboard: React.FC<DashboardProps> = ({
  ...
  return (
    <div className="flex flex-col h-full relative bg-slate-50 dark:bg-slate-900 transition-colors duration-200">
      {/* Header */}
      <div className="px-4 py-3 bg-white dark:bg-slate-800 border-b border-slate-100 dark:border-slate-700 shrink-0 flex items-center justify-between z-30 shadow-sm sticky top-0 transition-colors">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          {/* Sidebar / Left Column (Utilities & SRS) */}
          <div className="lg:col-span-4 space-y-6">
             ...
             <div>
                ...
                <div className="grid grid-cols-4 gap-2">
                  ...
                  <button onClick={onOpenHistory} className="flex flex-col items-center justify-center py-3 px-1 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl shadow-sm hover:shadow-md hover:border-orange-200 dark:hover:border-orange-700 hover:bg-orange-50/50 dark:hover:bg-orange-900/20 transition-all group h-24">
                    <div className="w-8 h-8 rounded-full bg-orange-100 dark:bg-orange-900/50 text-orange-600 dark:text-orange-400 flex items-center justify-center mb-1.5 group-hover:scale-110 transition-transform"><History size={16} /></div>
                  ...
                  <button onClick={onOpenVocab} className="flex flex-col items-center justify-center py-3 px-1 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl shadow-sm hover:shadow-md hover:border-emerald-200 dark:hover:border-emerald-700 hover:bg-emerald-50/50 dark:hover:bg-emerald-900/20 transition-all group h-24">
                    <div className="w-8 h-8 rounded-full bg-emerald-100 dark:bg-emerald-900/50 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mb-1.5 group-hover:scale-110 transition-transform"><BookOpen size={16} /></div>
                  ...
                  <button onClick={onOpenBackup} className="flex flex-col items-center justify-center py-3 px-1 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl shadow-sm hover:shadow-md hover:border-slate-300 dark:hover:border-slate-500 hover:bg-slate-50/50 dark:hover:bg-slate-700/30 transition-all group h-24">
                    <div className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 flex items-center justify-center mb-1.5 group-hover:scale-110 transition-transform"><Database size={16} /></div>
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            {libraryList.length === 0 && suggestionList.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 relative z-0">
                {filteredLibrary.map(lesson => {
                  ...
                  return (
                    <div
                      key={lesson.id}
                      onClick={() => onStartLesson(lesson)}
                      className="w-full p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 hover:border-indigo-300 dark:hover:border-indigo-500 hover:bg-indigo-50/30 dark:hover:bg-indigo-900/20 transition-all text-left group shadow-sm relative cursor-pointer flex flex-col"
                    >
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 line-clamp-2 mb-3 pl-10 flex-1">{lesson.description}</p>
                      <div className="flex items-center justify-between pt-2 border-t border-slate-50 dark:border-slate-700/50 pl-10 mt-auto">
                        <div className="flex items-center gap-2">
